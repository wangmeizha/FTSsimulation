...
StFtsCollection*
StEvent::ftsCollection()
{
    StFtsCollection *ftsCollection = 0;
    _lookup(ftsCollection, mContent);
    return ftsCollection;
}

const StFtsCollection*
StEvent::ftsCollection() const
{
    StFtsCollection *ftsCollection = 0;
    _lookup(ftsCollection, mContent);
    return ftsCollection;
...
void
StEvent::setFtsCollection(StFtsCollection* val)
{
    _lookupAndSet(val, mContent);
}
